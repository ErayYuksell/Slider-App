...
document.querySelector('.fa-solid fa-circle-arrow-left fa-2x arrow').addEventListener('click',function(){
    index--;
    showSlide(index);
    console.log(index);
});

document.querySelector('.fa-solid fa-circle-arrow-right fa-2x arrow').addEventListener('click',function(){
    index++;
    showSlide(index);
    console.log(index);    
});
